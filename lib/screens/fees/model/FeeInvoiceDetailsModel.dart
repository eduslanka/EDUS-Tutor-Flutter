...
FeeInvoiceDetailsModel feeInvoiceDetailsModelFromJson(String str) =>
    FeeInvoiceDetailsModel.fromJson(json.decode(str));

String feeInvoiceDetailsModelToJson(FeeInvoiceDetailsModel data) =>
