...
List<PlanDetails> planDetailsFromJson(String str) => List<PlanDetails>.from(
    json.decode(str).map((x) => PlanDetails.fromJson(x)));

String planDetailsToJson(List<PlanDetails> data) =>
